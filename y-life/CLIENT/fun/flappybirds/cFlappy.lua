...
function Flappy:Die(uWat)
	if(self.dead == false) then
		...
		Sound:New("FILES/sounds/flappybirds/sfx_hit.ogg");
		if not(uWat) then
			setTimer(function() Sound:New("FILES/sounds/flappybirds/sfx_die.ogg") end, 350, 1)
		end
	end
end
...
function Flappy:AddCoin()
	Sound:New("FILES/sounds/flappybirds/sfx_point.ogg")
...
function Flappy:ClickFlappy()
	if(self.dead ~= true) then
		...
		Sound:New("FILES/sounds/flappybirds/sfx_wing.ogg");
	else
