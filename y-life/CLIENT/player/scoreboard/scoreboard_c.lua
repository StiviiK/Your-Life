-- player/scoreboard/scoreboard_c.lua
...
function addScoreboardPlayerData()
	...
	for id, player in pairs(getElementsByType("player")) do 
		...
		elseif (getElementData(player, "player.socialstate") == "Downloading...") then
			onlinePlayer[id].socialstate = "Downloading..."
			onlinePlayer[id].hours = ""
			onlinePlayer[id].playtime = ""
			onlinePlayer[id].faction = 0
		else
...
function renderScoreboard()
	dxDrawRectangle(450*px,250*py,700*px,400*py,tocolor(0,0,0,200),true)
	dxDrawRectangle(450*px,250*py,700*px,20*py,tocolor(0,0,0,255),true)
	dxDrawText("Spielername",450*px,250*py,500*px,270*py,tocolor(255,255,255,255),0.5,"bankgothic","left", "center", false, false, true, false, false)
	dxDrawText("Status",670*px,250*py,500*px,270*py,tocolor(255,255,255,255),0.5,"bankgothic","left", "center", false, false, true, false, false)
	dxDrawText("Spielzeit",800*px,250*py,500*px,270*py,tocolor(255,255,255,255),0.5,"bankgothic","left", "center", false, false, true, false, false)
	dxDrawText("Ping",1000*px,250*py,500*px,270*py,tocolor(255,255,255,255),0.5,"bankgothic","left", "center", false, false, true, false, false)
	scoreboardZeile = 0
	for scorepos = 0+position_scoreboard  , 17+position_scoreboard  do 
		if onlinePlayer[scorepos] then
			...
			onlinePlayer[scorepos].playerping = getPlayerPing(onlinePlayer[scorepos].player)
			...
			elseif onlinePlayer[scorepos].playerping < 500 then
